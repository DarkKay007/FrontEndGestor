      ...
      {selectedProject && (
        <div className="w-full max-w-4xl bg-yellow-400 p-6 mt-6 rounded-lg shadow-md">
          ...
          <Button
            ...
            className="mt-4 ml-2 bg-blue-500 w-32 hover:bg-blue-800"
          >
            Add Task
          </Button>
          <Button
            onClick={handleOpenUpdateModal}
            className="mt-4 ml-2 bg-green-500 w-32 hover:bg-green-800"
          >
            Update Project
          </Button>
          ...
          {showUpdateModal && (
            <Modal show={showUpdateModal} onClose={handleCloseUpdateModal}>
              <Modal.Header className="bg-gray-900 text-yellow-500">
                Update Project
              </Modal.Header>
